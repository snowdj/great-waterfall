...
比如说，如果我妈给我多一块钱的预算，那我买苹果香蕉会不会变。
 ...
 2. Totla differentiate of I implicite function of foc.
     ...
     $$\begin{bmatrix}F_{11}& F_{12}\\F_{21} &F_{22} \\ \end{bmatrix}\begin{bmatrix} \frac{ d \bar x_1}{ d \alpha_1  }\\ \frac{ d \bar x_2}{ d \alpha_1  }\\ \end{bmatrix} =   \begin{bmatrix}} F_{1 \theta} \\F_{2 \theta} \\ \end{bmatrix} $$
